...
if dein#tap('defx-icons')
    let s:defx_options['columns'] = "indent:icons:filename:type"
endif

if dein#tap('defx-git')
    let s:defx_options['columns'] = "git:" . s:defx_options['columns']
endif

function! s:get_column_list()
    return  s:defx_options['columns']
endfunction
